...
# Conversion
mpo_dmrg_conversion.sweep_projection(flmps0,flmps1,ifQt,sval,thresh=1.e-6,Dcut=30,debug=False)
exit()
...
expect = mpo_dmrg_propsItrf.eval_S2Global(dmrg2,flmps0,spinfo=info)

...
# ibond/dim(NS)/dim(NSM)= 3 23 72
# ibond/dim(NS)/dim(NSM)= 4 27 85
# ibond/dim(NS)/dim(NSM)= 5 28 85
# ibond/dim(NS)/dim(NSM)= 6 28 83
# ibond/dim(NS)/dim(NSM)= 7 25 66
# ibond/dim(NS)/dim(NSM)= 8 21 48
# ibond/dim(NS)/dim(NSM)= 9 12 20
# ibond/dim(NS)/dim(NSM)= 10 1 1
t1 = time.time()
print 'dt=',(t1-t0)
exit()
